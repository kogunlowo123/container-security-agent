"""Container Security Agent - Main Agent Implementation."""
...
class ContainerSecurityAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.dockerfile_linting_enabled = True
        self.runtime_monitoring_enabled = True
        self.image_signing_enabled = True
        self.sbom_generation_enabled = True
        self._tool_dispatch = {
            "scan_image": self.tools.scan_image,
            "lint_dockerfile": self.tools.lint_dockerfile,
            "check_runtime_anomalies": self.tools.check_runtime_anomalies,
            "verify_image_signature": self.tools.verify_image_signature,
            "generate_sbom": self.tools.generate_sbom,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['image_scanning', 'dockerfile_linting', 'runtime_monitoring', 'image_signing', 'sbom_generation'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "check_runtime_anomalies": ['check', 'runtime', 'anomalies'],
            "verify_image_signature": ['verify', 'image', 'signature'],
